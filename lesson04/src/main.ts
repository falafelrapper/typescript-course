...
// ^Works the same way as the arrow function, both have the same type signatures as well and return a number

// Interfaces are more for classes that you can extend while functions should be type aliases instead
